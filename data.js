...
/* 產業別的【建議清單】。
   ⚠️ 這不是限制，只是輸入時的提示 —— 同學可以直接打自己的行業。
      原本做成 13 選 1 的下拉，但這班橫跨的行業比我們列得出來的多
      （能源、離岸風電、無人機、窗簾、磁磚建材…），
      選不到自己那一行的人只能勉強挑一個最接近的，篩選反而失真。
      名冊的產業篩選改用「實際出現過的值」動態產生。 */
const INDUSTRY_SUGGEST = [
  "不動產開發", "不動產仲介", "不動產估價", "營造工程", "建築師事務所",
  "工程顧問／技師", "室內裝修", "地政士／法務", "公部門", "學術教育",
  "資訊／電信", "製造／建材", "能源產業"
];
...
/* ⚠️ 十個職務的說明【長度與份量要相當】。
   這班每個人都是帶著工作來念的，說明寫得有輕重之分，
   等於在告訴擔任其他職務的人「你這個位子沒那麼要緊」。
   統一寫成：做什麼；為什麼這件事需要有人扛。
   ⛔ 不要用「支援」「雜務」「幫忙」這種把人寫成配角的詞。 */
const OFFICER_DESC = {
  "班代":     "對外代表班級，與學程辦公室、師長聯繫；班上的事第一個找他。",
  "副班代":   "與班代共同主持班務，對內統籌各組分工；班代不在時全權代理。",
  "學務":     "課務與學業的窗口：選課、修課規定、論文與指導教授的資訊彙整。",
  "總務":     "場地、器材與採買；活動當天能不能順利進行，靠總務事前備好。",
  "財務":     "班費的收支與帳目；繳費、報帳與經費怎麼用，都由財務把關。",
  "公關":     "對外聯繫與跨屆交流；把班上跟外面的人與資源接起來。",
  "活動":     "聚餐、參訪、班遊的規劃與執行；同學能不能真的熟起來，看活動。",
  "不動產組代":   "不動產經營管理組的窗口；該組的通知、意見與需求由他彙整。",
  "國土運輸組代": "國土城鄉規劃與運輸管理組的窗口；該組的通知與意見由他彙整。",
  "智慧防災組代": "智慧城市與營建防災組的窗口；該組的通知與意見由他彙整。"
};
